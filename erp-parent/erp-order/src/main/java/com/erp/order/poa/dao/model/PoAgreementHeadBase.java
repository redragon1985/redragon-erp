...
public class PoAgreementHeadBase {
    ...
    //采购协议金额
    @Column(name = "poa_amount", unique = false, nullable = false)
    private Double poaAmount;
    
    public Double getPoaAmount() {
        return this.poaAmount;
    }
    public void setPoaAmount(Double poaAmount) {
    ...
    @Column(name = "receive_status", unique = false, nullable = true, length = 10)
    ...
    @Column(name = "payment_status", unique = false, nullable = true, length = 10)
