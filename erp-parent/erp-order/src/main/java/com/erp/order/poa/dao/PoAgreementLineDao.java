...
public interface PoAgreementLineDao extends DaoCRUDIF<PoAgreementLine, PoAgreementLineCO>{
    
    //获取行列表（根据头code）
    public abstract List<PoAgreementLine> getPoLineListByPoHeadCode(Pages pages, PoAgreementLineCO paramObj);
