...
@RestController
@RequestMapping("/api/payLine")
public class PayLineApiController extends ControllerSupport{
    
    //日志处理
    private Logger logger = LoggerFactory.getLogger(PayLineApiController.class);
    ...
    public String getPayLineList(Pages pages, PayLineCO payLineCO) {
        //TODO: 分页查询数据
        if(pages.getPage()==0) {
            pages.setPage(1);
        }
        ...
        //分页查询数据
        List<PayLine> list = this.payLineService.getDataObjects(pages, payLineCO);
    ...
    public String getPayLine(PayLine payLine) {
        //TODO: 查询要编辑的数据
    ...
    public String editPayLine(@Valid PayLine payLine, BindingResult bindingResult) {
        //参数校验
        ...
        //保存编辑的数据
        this.payLineService.insertDataObject(payLine);
    ...
    public String deletePayLine(PayLine payLine) {
        //TODO: 删除数据前验证数据
