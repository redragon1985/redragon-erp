...
public class SysUserApiController extends ControllerSupport{
    ...
    public String getSysUserList(Pages pages, SysUserCO sysUserCO) {
        //TODO: 分页查询数据
        if(pages.getPage()==0) {
            pages.setPage(1);
        }
    ...
    public String getSysUser(SysUser sysUser) {
        //TODO: 查询要编辑的数据
    ...
    public String editSysUser(@Valid SysUser sysUser, BindingResult bindingResult) {
        //参数校验
