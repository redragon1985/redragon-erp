...
@Entity(name="finVoucherLineCommon")
@Table(name="fin_voucher_line", schema="erp")
@DynamicInsert(true)
@DynamicUpdate(true)
public class FinVoucherLine implements java.io.Serializable {

    //serialVersionUID
    private static final long serialVersionUID = 1L;

    //Constructors
    public FinVoucherLine() {
    }
    ...
    @Column(name = "dr_amount", unique = false, nullable = false)
    ...
    @Column(name = "cr_amount", unique = false, nullable = false)
