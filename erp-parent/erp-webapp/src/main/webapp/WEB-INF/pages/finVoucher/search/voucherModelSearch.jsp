...
<div id="searchDiv" class="ibox " style="display: none;">
	...
	<form action="web/finVoucherModelHead/getFinVoucherModelHeadList" method="get">
	<div class="ibox-content m-b-sm border-bottom">
		<div class="row">
			...
			<div class="col-sm-6">
				<div class="form-group">
					<label class="control-label" for="voucherNumber">模板名称</label> 
					<input type="text" id="modelName" name="modelName" value="${param.modelName}" class="form-control">
				</div>
			</div>
		</div>	
		<div class="row">
			<div class="col-sm-6">
				<div class="form-group">
					<label class="control-label" for="voucherNumber">业务类型</label> 
					<input type="text" id="businessType" name="businessType" value="${param.businessType}" class="form-control">
				</div>
			</div>
			<div class="col-sm-6">
				<div class="form-group">
