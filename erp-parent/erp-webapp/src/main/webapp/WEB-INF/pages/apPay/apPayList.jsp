...
<div class="wrapper wrapper-content animated fadeInRight">
	...
	<%-- 导入查询框 --%>
	<jsp:include page="search/apPaySearch.jsp"></jsp:include>
					...
					<div class="table-responsive">
						<table class="table table-striped table-hover table-bordered border-top">
							...
							<tbody>
							    ...
							    <c:forEach items="${requestScope.apPayHeadList}" var="data" varStatus="status">
								<tr>
									<%-- 
...
<script>
	$(document).ready(function() {
		...
		*/
		$("#addButton").click(function(){
		    window.location.href="web/apPayHead/getApPayHead";
		});
	...
	function editData(code){
		window.location.href="web/apPayHead/getApPayHead?payHeadCode="+code;
	}
	
	function deleteData(id, code, status) {
		redragonJS.confirm("确认删除数据？", function(){
			window.location.href="web/apPayHead/deleteApPayHead?payHeadId="+id+"&payHeadCode="+code+"&status="+status;
		});
	}
</script>       