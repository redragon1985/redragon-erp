			...
			<table class="table table-stripped table-hover table-bordered border-top">
				...
				<tbody>
					...
					<tr>
						...
						<td class="lineAmount" style="color: #1c84c6 !important;">${data.invoicePayAmount}</td>
...
<script>
	...
	function getLineModal(id, invoiceHeadCode, invoiceSourceHeadCode, receiverName, referenceNumber, invoiceDate, siAmount, siTaxAmount){
		$.ajax({
			type: "post",
			url: "web/apPayLine/getApPayLine",
			data: {"payLineId": id, "payHeadCode": "${param.payHeadCode}", "invoiceHeadCode": invoiceHeadCode, "poHeadCode": invoiceSourceHeadCode,
				   "receiverName": receiverName, "referenceNumber": referenceNumber, "invoiceDate": invoiceDate, "invoiceAmount": siAmount, "taxAmount": siTaxAmount},
			async: false,
			dataType: "html",
			cache: false,
	...
	function deleteLine(id){
		$.ajax({
			type: "post",
			url: "web/apPayLine/deleteApPayLine",
