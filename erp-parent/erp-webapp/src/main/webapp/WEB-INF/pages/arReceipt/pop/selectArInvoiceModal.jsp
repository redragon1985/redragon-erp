						...
						<tbody>
							...
							<c:forEach items="${requestScope.invoiceHeadList}" var="data" varStatus="status">
								<tr>
									...
									<td class="payerName">${data.payerName}</td>
		...
		$("#selectButton").click(function(){
			...
			$('.i-checks').each(function(){
				if($(this).prop("checked")){
					...
					payerName = $(this).parents("tr").find("td.payerName").text();
			...
			if(selectFlag=="N"){
				...
				getLineModal(null, invoiceHeadCode, invoiceSourceHeadCode, payerName, referenceNumber, invoiceDate, siAmount, siTaxAmount);
			}
		});
	});
