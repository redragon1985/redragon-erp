							...
							<div class="col-sm-12 col-sm-offset-2 text-right">
								...
								<c:if test="${param.inputHeadCode!=null&&param.inputHeadCode!=''}">
									...
									<c:if test="${requestScope.invInputHead.approveStatus=='SUBMIT' }">
										...
										<button class="btn btn-danger btn-lg btn-redragon-approve" type="button" onclick="window.location.href='web/invInputHead/updateApproveStatus?code=${requestScope.invInputHead.inputHeadCode}&approveStatus=REJECT'">&nbsp;&nbsp;驳回&nbsp;&nbsp;<i class="fa fa-times-circle"></i></button>&nbsp;
									</c:if>
