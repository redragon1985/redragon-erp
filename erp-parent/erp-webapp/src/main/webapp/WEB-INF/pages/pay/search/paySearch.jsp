...
<div id="searchDiv" class="ibox " style="display: none;">
	...
	<form action="web/payHead/getPayHeadList" method="get">
	<div class="ibox-content m-b-sm border-bottom">
		<div class="row">
			...
			<div class="col-sm-4">
				<div class="form-group">
					<label class="control-label" for="paySourceType">来源</label> 
...
$(document).ready(function(){
	...
	//设置paySourceType默认值
	if("${param.paySourceType}"!=""){
		$("#paySourceType").val("${param.paySourceType}");
	}
	//设置receiver默认值
	if("${param.receiver}"!=""){
