...
<script>
	...
	function getLineModal(id, poLineCode, materialCode, materialName, price, inputQuantity, unit, lineAmount){
		$.ajax({
			type: "post",
			url: "web/apInvoiceLine/getApInvoiceLine",
			data: {"invoiceLineId": id, "invoiceHeadCode": "${param.invoiceHeadCode}", "invoiceSourceType": $("#invoiceSourceType").val(), "invoiceSourceLineCode": poLineCode, "materialCode": materialCode,
	...
	function deleteLine(id){
		$.ajax({
			type: "post",
			url: "web/apInvoiceLine/deleteApInvoiceLine",
	...
	function getSelectPOLineModal(){
		...
		$.ajax({
			type: "post",
			url: "web/apInvoiceLine/getSelectPOLineModal",
			data: {"poHeadCode": $("#invoiceSourceHeadCode").val(), "invoiceHeadCode": "${param.invoiceHeadCode}"},
			async: false,
			dataType: "html",
			cache: false,
			success: function(data){
