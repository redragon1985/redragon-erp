...
<div class="wrapper wrapper-content animated fadeInRight">
	...
	<%-- 导入查询框 --%>
	<jsp:include page="search/apInvoiceSearch.jsp"></jsp:include>
			...
			<div class="ibox ">
		        <div class="ibox-title">
		            ...
		            <div class="ibox-tools">
		                <button id="addButton" class="btn btn-success btn-sm" type="button"><i class="fa fa-plus"></i>&nbsp;&nbsp;<span class="bold">新增采购发票</span></button>
						...
						<table class="table table-striped table-hover table-bordered border-top">
							...
							<tbody>
								...
								<tr>
									...
									<td>${requestScope.paySourceTypeMap[data.invoiceSourceType]}</td>
...
<script>
	$(document).ready(function() {
		...
		*/
		$("#addButton").click(function(){
		    window.location.href="web/apInvoiceHead/getApInvoiceHead";
		});
	...
	function editData(code){
		window.location.href="web/apInvoiceHead/getApInvoiceHead?invoiceHeadCode="+code;
	}
	
	function deleteData(id, code, status) {
		redragonJS.confirm("确认删除数据？", function(){
			window.location.href="web/apInvoiceHead/deleteApInvoiceHead?invoiceHeadId="+id+"&invoiceHeadCode="+code+"&status="+status;
		});
	}
</script>       