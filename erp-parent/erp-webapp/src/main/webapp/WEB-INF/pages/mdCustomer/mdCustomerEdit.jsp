							...
							<div class="col-sm-12 col-sm-offset-2 text-right">
								...
								<c:if test="${param.customerCode!=null&&param.customerCode!=''}">
									...
									<c:if test="${requestScope.mdCustomer.approveStatus=='SUBMIT' }">
										...
										<button class="btn btn-danger btn-lg btn-redragon-approve" type="button" onclick="window.location.href='web/mdCustomer/updateApproveStatus?code=${requestScope.mdCustomer.customerCode}&approveStatus=REJECT'">&nbsp;&nbsp;驳回&nbsp;&nbsp;<i class="fa fa-times-circle"></i></button>&nbsp;
									</c:if>
...
<script>
	...
	function approveData(){
		redragonJS.confirm("确认审批通过？", function(){
			window.location.href='web/mdCustomer/updateApproveStatus?code=${requestScope.mdCustomer.customerCode}&approveStatus=APPROVE';
		});
	}
	...
	function alterData(){
		redragonJS.confirm("确认变更数据？数据变更可能会影响到已有的业务！", function(){
			window.location.href='web/mdCustomer/updateApproveStatus?code=${requestScope.mdCustomer.customerCode}&approveStatus=UNSUBMIT';
		});
	}
