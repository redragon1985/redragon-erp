			...
			<div class="modal-body" style="padding-bottom: 20px;">
				...
				<form id="cform">
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input id="contactName" name="contactName" type="text" class="form-control" value="${requestScope.mdCustomerContact.contactName}">
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input id="contactTelephone" name="contactTelephone" type="text" class="form-control" value="${requestScope.mdCustomerContact.contactTelephone}">
						</div>
					</div>
					<div class="hr-line-dashed"></div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input id="contactPosition" name="contactPosition" type="text" class="form-control" value="${requestScope.mdCustomerContact.contactPosition}">
						</div>
					</div>
					<div class="hr-line-dashed"></div>
					...
					<input type="hidden" id="contactId" name="contactId" value="${requestScope.mdCustomerContact.contactId}"> 
					<input type="hidden" id="createdDate" name="createdDate" value="${requestScope.mdCustomerContact.createdDate}"> 
					<input type="hidden" id="createdBy" name="createdBy" value="${requestScope.mdCustomerContact.createdBy}">
				</form>
			</div>
...
<script>
	$(document).ready(function() {
		//初始化status
		if("${requestScope.mdCustomerContact.status}"!=""){
			$("#status").val("${requestScope.mdCustomerContact.status}");
		}
	...
	function editContact(){
		...
		$.ajax({
			type: "post",
			url: "web/mdCustomerContact/editMdCustomerContact",
			...
			success: function(data){
				...
				if(json.result=="success"){
					getContactTab($("#customerCode").val());
				}else{
