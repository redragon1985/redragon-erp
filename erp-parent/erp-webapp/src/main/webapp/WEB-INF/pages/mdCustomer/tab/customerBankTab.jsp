...
<script>
	...
	function getAddBankModal(id){
		$.ajax({
			type: "post",
			url: "web/mdCustomerBank/getMdCustomerBank",
			data: {"bankId": id, "customerCode": "${param.customerCode}"},
			async: false,
			dataType: "html",
			cache: false,
	...
	function deleteBank(id){
		$.ajax({
			type: "post",
			url: "web/mdCustomerBank/deleteMdCustomerBank",
			data: JSON.stringify({"bankId": id, "customerCode": "${param.customerCode}"}),
