...
<div class="wrapper wrapper-content animated fadeInRight">
	...
	<%-- 导入查询框 --%>
	<jsp:include page="search/receiptSearch.jsp"></jsp:include>
...
<script>
	$(document).ready(function() {
		...
		*/
		$("#addButton").click(function(){
		    window.location.href="web/receiptHead/getReceiptHead";
		});
	...
	function editData(code){
		window.location.href="web/receiptHead/getReceiptHead?receiptHeadCode="+code;
	}
	
	function deleteData(id, code, status) {
		redragonJS.confirm("确认删除数据？", function(){
			window.location.href="web/receiptHead/deleteReceiptHead?receiptHeadId="+id+"&receiptHeadCode="+code+"&status="+status;
		});
	}
</script>       