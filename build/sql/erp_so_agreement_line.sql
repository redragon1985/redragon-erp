...
--
-- Table structure for table `so_agreement_line`
--

DROP TABLE IF EXISTS `so_agreement_line`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `so_agreement_line` (
  `so_line_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '销售协议行id',
  `so_line_code` varchar(45) NOT NULL COMMENT '销售协议行编码',
  ...
  KEY `IX_soa_line_soa_head_code` (`so_head_code`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='销售协议行表';
...
-- Dump completed on 2021-03-05 16:07:24
