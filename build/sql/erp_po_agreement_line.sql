...
--
-- Table structure for table `po_agreement_line`
--

DROP TABLE IF EXISTS `po_agreement_line`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `po_agreement_line` (
  `po_line_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '采购协议行id',
  `po_line_code` varchar(45) NOT NULL COMMENT '采购协议行编码',
  ...
  UNIQUE KEY `po_line_code_UNIQUE` (`po_line_code`) /*!80000 INVISIBLE */,
  KEY `IX_poa_line_poa_head_code` (`po_head_code`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='采购协议行表';
