...
--
-- Table structure for table `so_agreement_head`
--

DROP TABLE IF EXISTS `so_agreement_head`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `so_agreement_head` (
  `so_head_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '销售协议头id',
  `so_head_code` varchar(45) NOT NULL COMMENT '销售协议头编码',
  `so_type` varchar(45) NOT NULL COMMENT '销售协议类型',
  `so_name` varchar(45) NOT NULL COMMENT '销售协议名称',
  `so_desc` varchar(500) DEFAULT NULL COMMENT '销售协议描述',
  `project_code` varchar(45) DEFAULT NULL COMMENT '项目编码',
  `customer_code` varchar(45) NOT NULL COMMENT '客户编码',
  `currency_code` varchar(45) NOT NULL COMMENT '销售协议币种',
  `soa_amount` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '销售协议金额',
  `pre_receipt_amount` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '销售协议预收款金额',
  `start_date` date DEFAULT NULL COMMENT '销售协议开始日期',
  `end_date` date DEFAULT NULL COMMENT '销售协议结束日期',
  `sign_date` date DEFAULT NULL COMMENT '销售协议签订日期',
  ...
  UNIQUE KEY `so_head_code_UNIQUE` (`so_head_code`),
  UNIQUE KEY `so_name_UNIQUE` (`so_name`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='销售协议头表';
...
-- Dump completed on 2021-03-05 16:07:26
